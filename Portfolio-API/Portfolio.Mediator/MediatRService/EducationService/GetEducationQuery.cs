...
namespace Portfolio.API.MediatR.MediatRService.EducationService
{
    ...
    public record GetEducationsQuery : IRequest<ServiceResponse<List<EducationModel>>>;

    public record GetEducationsHandler(IDbContextFactory<ApplicationDbContext> DbContextFactory,
        IMapper Mapper, IMediator Mediator) :
        IRequestHandler<GetEducationsQuery, ServiceResponse<List<EducationModel>>>
    {
        public async Task<ServiceResponse<List<EducationModel>>> Handle(GetEducationsQuery request, 
