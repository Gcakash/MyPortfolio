...
namespace Portfolio.API.MediatR.MediatRService.SkillService
{
    ...
    public record GetSkillsQuery : IRequest<ServiceResponse<List<SkillModel>>>;

    public record GetSkillsHandler(IDbContextFactory<ApplicationDbContext> DbContextFactory,
        IMapper Mapper, IMediator Mediator) :
        IRequestHandler<GetSkillsQuery, ServiceResponse<List<SkillModel>>>
    {
        public async Task<ServiceResponse<List<SkillModel>>> Handle(GetSkillsQuery request, 
