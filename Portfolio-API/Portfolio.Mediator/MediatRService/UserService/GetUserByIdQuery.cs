...
namespace Portfolio.API.MediatR.MediatRService.UserService
{
    ...
    public record GetUserByIdQuery(int UserId) : IRequest<ServiceResponse<UserInfoModel>>;

    public record GetUserByIdHandler(IDbContextFactory<ApplicationDbContext> DbContextFactory,
